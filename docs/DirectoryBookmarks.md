...
1. Install Java17+.
2. Download the file [DirectoryBookmarks.java](https://github.com/pponec/PPScriptsForJava/blob/development/src/main/java/net/ponec/script/DirectoryBookmarks.java) to a local directory 
...
**Note:** The easiest way for Ubuntu is to download and run the installation script [installDirectoryBookmarks.sh](https://github.com/pponec/PPScriptsForJava/blob/development/src/main/java/net/ponec/script/installDirectoryBookmarks.sh).
